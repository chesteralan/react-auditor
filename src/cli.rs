...
///
/// Powered by oxc, this tool lints your React codebase for quality, correctness,
/// security, performance, and accessibility issues.
///
...
pub struct Cli {
    ...
    /// Auto-fix violations where supported
    #[arg(long)]
    pub fix: bool,
